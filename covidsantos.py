...
plt.plot(df['date'], df['firstdose'], label = '1ª dose (estimativa)', color='lightcoral')
plt.fill_between(df['date'], df['firstdose'], color="lightcoral", alpha=0.8)
#plt.bar(date2num(df['date']), df['firstdose'], label = '1ª dose (estimativa)', width=w)
plt.plot(df['date'], df['seconddose'], label = '2ª dose (estimativa)', color='lightgreen')
plt.fill_between(df['date'], df['seconddose'], color="lightgreen", alpha=0.8)
