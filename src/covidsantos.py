...
fig.savefig(os.path.join(graphpath, 'cases.jpg'), bbox_inches='tight', dpi=150)
#plt.show()
...
plt.title('New Cases')
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'newcases.jpg'), bbox_inches='tight', dpi=150)
#plt.show()
...
plt.xscale('log')
#plt.xlabel('Date') 
plt.title('New Cases X Cases')
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'newcasescases.jpg'), bbox_inches='tight', dpi=150)
#plt.show()
...
plt.title('Deaths')
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'deaths.jpg'), bbox_inches='tight', dpi=150)
#plt.show()
...
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'newdeaths.jpg'), bbox_inches='tight', dpi=150)
#plt.show()
...
plt.xscale('log')
#plt.xlabel('Date') 
plt.title('New Deaths X Deaths')
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'newdeathsdeaths.jpg'), bbox_inches='tight', dpi=150)
#plt.show()

print('creating graphic: Hospitalization')
fig = plt.figure(figsize=(10,5))
plt.plot(df['date'], df['hospitalizeds'], label = 'hospitalizeds')
plt.plot(df['date'], df['UTI'], label = 'UTI')
#plt.xlabel('Date') 
plt.title('Hospitalization')
plt.legend()
plt.tick_params(axis = 'both', which = 'major' , labelsize = 16)
fig.savefig(os.path.join(graphpath, 'hospitalization.jpg'), bbox_inches='tight', dpi=150)
#plt.show()